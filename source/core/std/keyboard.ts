const decode = (input?: BufferSource | undefined, options?: TextDecodeOptions | undefined) =>
    new TextDecoder().decode(input, options);

const encode = (input?: string | undefined) => new TextEncoder().encode(input);
...
export function decodeKeypress(message: Uint8Array): Keypress[] {
    ...
    if (sequence === "\r") {
        ...
        const results: Keypress[][] = sequence
            .split("")
